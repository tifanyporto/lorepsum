...
function Logo({className="w-12 h-12", muted=false}: LogoProps) {
  ...
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className}>
      <line x1="23" y1="24" x2="10" y2="17" stroke={color} strokeWidth="2.2" strokeLinecap="round" />
      <line x1="23" y1="24" x2="37" y2="13" stroke={accentColor} strokeWidth="2.6" strokeLinecap="round" />
      <line x1="23" y1="24" x2="17" y2="38" stroke={color} strokeWidth="2.2" strokeLinecap="round" />
      <line x1="23" y1="24" x2="37" y2="35" stroke={color} strokeWidth="2.2" strokeLinecap="round" />
